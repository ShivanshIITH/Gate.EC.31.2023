...
\begin{equation}
P_s = \frac{1}{N} \int_{0}^{T} \sin^2(\omega t) \, dt
\end{equation}
...
\begin{equation}
P_e = \int_{-\frac{q}{2}}^{\frac{q}{2}} p(e) e^{2} \, de \approx \frac{2^{-2n}}{3}
\end{equation}
...
\begin{itemize}
  \item $SNR$ is the signal-to-noise ratio in dB, which is given as $61.96$ dB in our case.
